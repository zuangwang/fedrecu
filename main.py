...
for i in range(5):
    ...
    fname = os.path.join(results_path,f"{dataset}_e{communication_round}_hom{iid}_0_L_{L}_dir_{dir_alpha}_top5.csv")  # Changed args.test_num to 0
